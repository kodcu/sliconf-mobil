		...
		return (
			<View style={{ flex: 0.8, backgroundColor: Color.white, marginTop: 8 }}>
				...
				<View style={{
					...
					<TouchableOpacity onPress={() => {
						...
						<View style={{ flexDirection: 'row', alignItems: 'center' }}>
							...
							<Text style={{
								...Font.regular, fontSize: Scale.moderateScale(13), color: Color.darkGray3,
				...
				<ButtonComponent
					...
					textStyle={{ ...Font.semiBold, fontSize: Scale.moderateScale(15), letterSpacing: 0 }}
					states={{
						request: {
							onPress: () => {
...
export default connect(mapStateToProps)(SendQuestionView);