...
import {View, TouchableOpacity, Text, ListView, Image,Platform} from 'react-native'
        ...
        <View style={{flex:1,justifyContent:'space-between',flexDirection: 'row'}}>
            <TouchableOpacity style={{flexDirection: 'row', padding: 5,flex:0.8}} onPress={() => {}}>
                <Image source={profileUrl === '' ? require('../../images/hi.png') : {uri: profileUrl}} resizeMode="contain"
                       style={{margin: 5, width: 60, height: 60, borderRadius:Platform.OS === 'ios' ? 30 : 40}}/>
    ...
    <View style={{flexDirection: 'row'}}>
        <TouchableOpacity style={{
            ...
            <Image source={require('../../images/hi.png')} resizeMode="contain"
                   style={{width: 60, height: 60, borderRadius: Platform.OS === 'ios' ? 30 : 40}}/>
