...
export const reducer = (state = initialState, action) => {
	...
	switch (type) {
		case types.SCHEDULE_POST_REQUEST || types.SCHEDULE_GET_REQUEST: {
			return {
				...state,
				loading: true,
				error: false,
		...
		case types.SCHEDULE_POST_SUCCESS ||
			types.SCHEDULE_GET_SUCCESS ||
			types.SCHEDULE_DELETE_SUCCESS
			: {
				return {
					...state,
					loading: false,
		...
		case types.SCHEDULE_POST_FAIL || types.SCHEDULE_GET_FAIL: {
			return {
				...state,
				loading: false,
				error: true,
